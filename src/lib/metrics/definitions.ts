...
export const METRIC_DEFINITIONS: MetricDefinition[] = [
  { key: 'spend',              label: 'Inversión',          unit: 'currency', channels: ['meta','google','tiktok'], is_derived: false },
  { key: 'impressions',        label: 'Impresiones',        unit: 'integer',  channels: ['meta','google','tiktok'], is_derived: false },
  { key: 'clicks',             label: 'Clics',              unit: 'integer',  channels: ['meta','google','tiktok'], is_derived: false },
  { key: 'conversions',        label: 'Conversiones',       unit: 'integer',  channels: ['meta','google','tiktok'], is_derived: false },
  { key: 'conversions_value',  label: 'Ingresos',           unit: 'currency', channels: ['meta','google','tiktok'], is_derived: false },
  ...
  { key: 'cvr',                label: 'Tasa de conv.',      unit: 'percent',  channels: ['meta','google','tiktok'], is_derived: true,  formula: 'conversions / clicks * 100' },
  { key: 'cpa',                label: 'Costo por conv.',    unit: 'currency', channels: ['meta','google','tiktok'], is_derived: true,  formula: 'spend / conversions' },
];
